...
console.log(new Date("Mon Sep 12 2022 10:37:12"));
console.log(new Date("December 24, 2022"));

console.log(new Date(account1.movementsDates[0]));

console.log(new Date(2037, 10, 19, 15, 25, 50));
console.log(new Date(2037, 10, 31)); // autocorrect date
...
console.log(new Date(2142253500000));
